...
exports.book_index = function (req, res) {
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      function (err, results) {
        ...
        // Make our selected genre as cheked
...
exports.book_delete_post = function (req, res, next) {
  ...
  function (err, results) {
    ...
    if (results.book_instances.length > 0) {
      // Book has BookInstance. Render in same way as GET route
...
exports.book_update_get = function (req, res, next) {
  ...
  function (err, results) {
    ...
    for (var g_iter = 0; g_iter < results.genres.length; g_iter++) {
      for (var b_iter = 0; b_iter < results.book.genre.length; b_iter++) {
        if (results.genres[g_iter]._id.toString() == results.book.genre[b_iter]._id.toString()) {
          results.genres[g_iter].checked = 'true';
        }
      }
    }
